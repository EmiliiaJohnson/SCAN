    ...
    <div className="burger-button__open" onClick={() => setIsActive(true)}>
        ...
        <div className="burger-menu"> 
            ...
            <nav className="burger-nav">
                <Link className="burger-nav__link" to= "/">Главная</Link>
                <a className="burger-nav__link" href= "#tariffs">Тарифы</a>
                <Link className="burger-nav__link" to= "/error">FAQ</Link>
            </nav>
            {store.token ? 
            ...
            <div className="burger__not-signed">
                <Link className="burger__sign-up" to="/error">Зарегистрироваться</Link>
                <Link className="burger__sign-in"to="/auth">Войти</Link>
            </div>}
        </div>) : (<></>)}
